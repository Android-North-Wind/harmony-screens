...
export interface BottomTabsScreenProps {
  ...
  /**
   * @summary Directly specifies the icon image source for the tab bar item.
   * 
   * This is a Harmony/Android-specific prop that allows direct specification of icon image source.
   * Can be used instead of the `icon` prop for simpler usage.
   * 
   * @platform android, harmony
   */
  iconImageSource?: ImageSource;
  /**
   * @summary Directly specifies the selected icon image source for the tab bar item.
   * 
   * This is a Harmony/Android-specific prop that allows direct specification of selected icon image source.
   * Can be used instead of the `selectedIcon` prop for simpler usage.
   * 
   * @platform android, harmony
   */
  selectedIconImageSource?: ImageSource;
  /**
   * @summary Specifies the icon type.
   * 
   * @platform android, harmony
   */
